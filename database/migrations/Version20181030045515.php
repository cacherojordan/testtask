...
class Version20181030045515 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE mail_chimp_members (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', email_address VARCHAR(255) NOT NULL, email_type VARCHAR(255) DEFAULT NULL, status VARCHAR(255) NOT NULL, merge_fields LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', interests LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', language VARCHAR(255) DEFAULT NULL, vip TINYINT(1) DEFAULT NULL, location LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', marketing_permissions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', list_id VARCHAR(255) DEFAULT NULL, unique_email_id VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
    }
